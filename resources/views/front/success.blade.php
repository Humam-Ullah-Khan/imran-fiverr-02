...
<div class="row">
    ...
    <style>
      ...
      <div class="card">
      <div style="border-radius: 200px; height: 200px; width: 200px; background: #F8FAF5; margin: 0 auto; display: flex; justify-content: space-between; align-content: space-around; flex-direction: column; flex-wrap: wrap;">
      ...
      <p>Thank you for your order. order detail are below.</p>
        ...
        <form method="post">
          ...
          <div class="form-group">
            ...
            <input type="email" name="emailaddress" class="form-control emailaddress" value="{{$data->email}}" readonly disabled placeholder="Enter Email Address" required>
          </div>
